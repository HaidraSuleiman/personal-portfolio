...
export const heroIcons = [
  {
    ...
    path: "https://www.instagram.com/haydara.sliman",
  },
  {
    icon: <FacebookCircleLineIcon />,
    path: "https://facebook.com/haydara.sliman.3",
  },
  { icon: <DribbbleLineIcon />, path: "#" },
  {
    icon: <RiLinkedinBoxLine />,
    path: "https://www.linkedin.com/in/haidra-suleiman-960677212",
  },
  { icon: <GithubLineIcon />, path: "https://www.github.com/haidrasuleiman" },
];
...
export const aboutData = [
  ...
  {
    title: "Highest Graduation Grade Nationally",
    amount: 1,
    icon: <AwardFillIcon />,
  },
];
...
export const experienceData = [
  ...
  {
    year: 2016,
    title: "Information Technology and Computer Science degree",
    education:
      "Bachelor’s Degree in IT Engineering and Computer Science: Enroll in a 5-year program covering IT, software and design principles.",
    experience: [
      "Multiple projects: Take on small projects to build a portfolio.",
      "Online Courses and Certifications: Learn JavaScript, responsive design, and UX/UI design.",
      "Graduation project: Build a website and a small Flutter android app.",
    ],
  },
  {
    year: 2021,
    ...
    experience: [
      "More personal projects: Applying all knowledge in Real-World web apps",
  ...
  },
  {
    year: 2022,
    title: "First IT role",
    education: "Welbond Armatures - IT Engineer",
    experience: [
...
export const reviewsData = [
  {
    ...
    name: " Stephan F, Manager",
    comment:
      "A dependable and result-driven individual who consistently exceeded expectaions, demonstrated professionalism, initiative and a strong work ethic throughout every project he contributed to",
    stars: [1, 1, 1, 1, 0.5],
  },
  {
    image: "/reviews/client-4.png",
    name: "Ahmad S, University Professor",
    comment:
      "Among the strongest students I have taught, demonstrating intellectual curiosity, discipline and a remarkable ability to deliver polished, impactful work on time.",
    stars: [1, 1, 1, 1, 1],
  },
  {
    image: "/reviews/client-2.png",
    name: "Zain T, Graduation Project ",
    comment:
      "Working with you, has been an absolute pleasure. The pharmacy locator website we created for me is sleek, modern, and beautifully showcases our work. Your attention to detail and creative flair are truly impressive. I couldn't be happier with the final result!",
    stars: [1, 1, 1, 1, 1],
  },
];
